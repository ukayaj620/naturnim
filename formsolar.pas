...
// core function
function TFormSol.CartesiusToMonitor(point: TPoint): TPoint;
var
  tempPoint: TPoint;
begin
...
// drawing utility
procedure TFormSol.clearCanvas();
begin
  noStroke();
  fill(clWhite);
...
procedure TFormSol.Ellipse(pos: TPoint; radius: double);
var
  pointMonitor: TPoint;
begin
...
procedure TFormSol.rect(x: double; y: double; w: double; h: double);
begin
...
procedure TFormSol.Revolution(index: integer; revolutionDegree: double);
var
  tempPoint: TPoint;
  rad: double;
begin
...
procedure TFormSol.FormCreate(Sender: TObject);
begin
  FPS.Enabled:= false;
...
procedure TFormSol.FormShow(Sender: TObject);
begin
...
procedure TFormSol.FPSTimer(Sender: TObject);
begin
  clearCanvas();
...
procedure TFormSol.BtnStartClick(Sender: TObject);
begin
  FPS.Enabled:= true;
end;

procedure TFormSol.BtnRotateClick(Sender: TObject);
var
  i: integer;
begin
  // Revolusi
